...
// ("gbounce") with the deterministic seed bytes(range(32)) and asserts
...
func TestCrossImpl_ManifestSignatureForThisProduct(t *testing.T) {
	const thisProduct = "gbounce"
	// Computed offline from the Python reference impl with seed
	// bytes(range(32)) over a manifest with bouncer_product=thisProduct.
	const wantSigB64 = "SXSRGbaGz9UIHdfoUopvUaegfzYkDqm174e35hsQhtQzmyRJBxWjsmWU42bkKQ0NGLYLoj6jub8P3nPGJa5bCQ"
