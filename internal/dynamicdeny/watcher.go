...
// is wired but gbounce is not advertised as a Windows product.
//
// Design notes
// ------------
//
...
// Used by tests + by operators who route gbounce's stderr through a
// custom sink.
...
func (w *Watcher) Start(ctx context.Context) error {
	...
	// it doesn't exist, the file can't exist either; emit a warning
	// rather than failing (the operator may be about to create both).
